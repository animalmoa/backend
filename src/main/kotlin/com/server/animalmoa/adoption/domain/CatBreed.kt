...
enum class CatBreed(
    ...
    BENGAL("뱅갈", setOf("뱅갈")),
    BRITISH_SHORTHAIR("브리티쉬 숏헤어", setOf("브리티쉬 숏헤어", "브리티시 숏헤어")),
    SIAM("샴", setOf("샴")),
    SCOTTISH_FOLD("스코티쉬 폴드", setOf("스코티쉬 폴드", "스코티시 폴드")),
    ...
    ORIENTAL("오리엔탈", setOf("오리엔탈", "오리엔탈 롱헤어", "오리엔탈 숏헤어")),
    CHINCHILLA("친칠라", setOf("친칠라")),
    TURKISH_ANGORA("터키쉬 앙고라", setOf("터키쉬 앙고라", "터키시 앙고라")),
    PERSIAN("페르시안", setOf("페르시안")),
    KOREAN_SHORTHAIR("한국 고양이", setOf("한국 고양이", "코리안 숏헤어")),
    ;
